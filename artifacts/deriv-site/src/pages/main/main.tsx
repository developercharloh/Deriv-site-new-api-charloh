...
const AppWrapper = observer(() => {
    ...
    React.useEffect(() => {
        ...
        const el_tutorial = document.getElementById('id-ai-analysis');
    ...
    React.useEffect(() => {
        ...
        if (active_tab === DBOT_TABS.FREE_BOTS && !isDesktop) {
                    ...
                    <div>
                        ...
                        <Tabs active_index={active_tab} className='main__tabs' onTabItemClick={handleTabChange} top>
                            ...
                            <div
                                ...
                                id='id-advanced-dtrader'
                            >
                                <Suspense fallback={<ChunkLoader message={localize('Loading Advanced D-Trader...')} />}>
                                    <AdvancedDTrader />
                                </Suspense>
                            </div>
                        </Tabs>
